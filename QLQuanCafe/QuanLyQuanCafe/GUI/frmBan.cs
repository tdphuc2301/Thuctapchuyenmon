...
namespace GUI
{
    public partial class frmBan : Form
    {
        ...
        {
            DataTable dt = BUS.DanhSachTimKiem(txtMaBan.Text, txtTenBan.Text, nmSoLuongNguoi.Value, txtGhiChu.Text);
        ...
        private void grdBan_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                nmSoLuongNguoi.Text = row.Cells[2].Value.ToString();
