...
namespace GUI
{
    public partial class frmThongTin_NhanVien : Form
    {
        ...
        private void DanhSachTaiKhoan_NhanVien ()
        {
            ...
            grdTK_NV.Columns[1].Width = 150;
            grdTK_NV.Columns[2].Width = 100;
            grdTK_NV.Columns[3].Width = 150;
        ...
        {
            DataTable dt = BUS.DanhSachTimKiem(txtMaTK_NV.Text, txtTenTK_NV.Text, txtSoDienThoai.Text, txtDiaChi.Text);
